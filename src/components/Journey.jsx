...
const milestones = [
  ...
  },
  {
    step: '09',
    year: '2026',
    title: 'Tech Head @ CodeBreakers & HackVerse',
    desc: 'Appointed Technical Lead at CodeBreakers (codebreakersgcek.tech), the official coding club of GCEK. Architected hackverse.codebreakersgcek.tech for the flagship 24H state tech fest & hackathon.',
    side: 'left',
    color: 'purple',
    tag: 'Tech Head & HackVerse',
  },
  {
    step: '10',
    year: '2026+',
    title: 'The Road Ahead',
    desc: 'Focusing on AI-driven systems, secure architectures, distributed systems, and impactful community developer platforms.',
    side: 'right',
    color: 'blue',
    tag: 'Future Horizon',
  },
